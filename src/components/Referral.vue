        ...
        <div class="row mt-1">
          <div class="col-md-6 offset-md-3">
            <input 
              ...
              :value="'https://domains.cheetahlabs.io/#/'+getUrlPath+'?ref=' + this.getNameOrAddress"
              @click="copyToClipboard('https://domains.cheetahlabs.io/#/'+getUrlPath+'?ref=' + this.getNameOrAddress)"
              readonly
            >
          </div>
        </div>
