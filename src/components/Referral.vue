        ...
        <div class="row mt-1">
          <div class="col-md-6 offset-md-3">
            <input 
              ...
              :value="'http://www.ensartvault.com/#/'+getUrlPath+'?ref=' + this.getNameOrAddress"
              @click="copyToClipboard('http://www.ensartvault.com/#/'+getUrlPath+'?ref=' + this.getNameOrAddress)"
              readonly
            >
          </div>
        </div>
